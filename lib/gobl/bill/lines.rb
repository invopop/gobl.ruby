...
module GOBL
  module Bill
    ...
    class Lines < GOBL::Struct
      ...
      # The Schema ID of the GOBL Lines structure
      ...
      #     @return [Line] the element in the `index` position
      ...
      #     @return [Array<Line>] the elements in the range
      #   @overload [](range)
      ...
      #
      # @return [Lines] the object created from the given data
      ...
      # Returns a {Lines} object from a given array of structs. The array may
      # contain {Line} objects or hashes. If hashes are provided, the constructor
      # will call `Line#new` to generate the objects that will be part of the
      # returned {Lines} object
      #
      # @param object [Array<Line, Hash>] the array containing the structs
      #
      # @return [Lines] the object corresponding to the given input
      def self.new(object)
        case object
        when Array
          super _ary: object
