...
module GOBL
  module Bill
    ...
    class Charges < GOBL::Struct
      ...
      # The Schema ID of the GOBL Charges structure
      ...
      #     @return [Charge] the element in the `index` position
      ...
      #     @return [Array<Charge>] the elements in the range
      #   @overload [](range)
      ...
      #
      # @return [Charges] the object created from the given data
      ...
      # Returns a {Charges} object from a given array of structs. The array may
      # contain {Charge} objects or hashes. If hashes are provided, the constructor
      # will call `Charge#new` to generate the objects that will be part of the
      # returned {Charges} object
      #
      # @param object [Array<Charge, Hash>] the array containing the structs
      #
      # @return [Charges] the object corresponding to the given input
      def self.new(object)
        case object
        when Array
          super _ary: object
