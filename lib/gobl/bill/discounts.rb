...
module GOBL
  module Bill
    ...
    class Discounts < GOBL::Struct
      ...
      # The Schema ID of the GOBL Discounts structure
      ...
      #     @return [Discount] the element in the `index` position
      ...
      #     @return [Array<Discount>] the elements in the range
      #   @overload [](range)
      ...
      #
      # @return [Discounts] the object created from the given data
      ...
      # Returns a {Discounts} object from a given array of structs. The array may
      # contain {Discount} objects or hashes. If hashes are provided, the constructor
      # will call `Discount#new` to generate the objects that will be part of the
      # returned {Discounts} object
      #
      # @param object [Array<Discount, Hash>] the array containing the structs
      #
      # @return [Discounts] the object corresponding to the given input
      def self.new(object)
        case object
        when Array
          super _ary: object
